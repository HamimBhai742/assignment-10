            ...
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dark:text-white dropdown-content z-50 p-2 shadow bg-base-100 rounded-box w-52">
                ...
                <div className="navbar-end gap-3 font-inter text-lg">
                    <label className="cursor-pointer grid place-items-center">
                        <input type="checkbox" onClick={themControll} value="synthwave" className="toggle theme-controller bg-base-content row-start-1 col-start-1 col-span-2" />
