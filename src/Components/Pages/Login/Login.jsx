        ...
        <div className='max-sm:mx-3'>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-[#328EFF26] md:mx-auto font-raleway text-gray-800">
                ...
                <div className="flex justify-center space-x-4">
                    <button onClick={handelGoogleLoginBtn} aria-label="Log in with Google" className="p-3 rounded-sm">
                    ...
                    <button onClick={handelGitHubLoginBtn} aria-label="Log in with GitHub" className="p-3 rounded-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-7 h-7 fill-current">
                ...
                <p className="text-sm font-medium text-center">Don't have an account?
                    <Link to='/register' rel="noopener noreferrer" href="#" className="hover:underline ml-1 text-violet-600">Register</Link>
                </p>
            </div>
        </div>
    );
