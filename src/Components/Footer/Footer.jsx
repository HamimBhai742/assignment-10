...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-[#328EFF26] dark:text-gray-800 mt-8">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-5 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3 font-inter">
                        ...
                        <ul className="space-y-1 max-sm:text-sm">
                            ...
                            <li>
                                <a rel="noopener noreferrer" href="#">Knitting & Crocheting</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Quilting
</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Macrame</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-3 ml-24">
                        <div className="uppercase text-lg dark:text-gray-900 font-semibold w-32">Social media</div>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600 font-raleway">© 1968 Company Co. All rights reserved.</div>
        </footer>
    );
};
